...
void Interno() {
  ...
  for (int i = 0; i < 15; i++) {  // borde
    leds6.setPixelColor(i, 190/multiple_test, 150/multiple_test, 90/multiple_test);
  }

  for (int i = 15; i < 43; i++) {  // borde
    leds6.setPixelColor(i, 50 * brillo / 100, 50 * brillo / 100, 50 * brillo / 100);
  }

  for (int i = 43; i < NUMLEDS6; i++) {  // borde
    leds6.setPixelColor(i, 190/multiple_test, 150/multiple_test, 90/multiple_test);
  }
...
void Externo() {
  ...
  for (int i = 0; i < 2; i++) {
    leds.setPixelColor(random(NUMLEDS), 80, 80, 80);
  }
